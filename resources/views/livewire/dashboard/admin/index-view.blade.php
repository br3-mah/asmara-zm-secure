								...
								<div class="card booking">
									<div class="card-body">
										<div class="booking-status d-flex align-items-center">
											<span>
												<svg xmlns="http://www.w3.org/2000/svg" style="color:##ff5200;" width="28" height="20" viewBox="0 0 28 20">
											...
											<div class="ms-4">
												<h2 class="mb-0 font-w600">{{ $tt_booking }}</h2>
												<p class="mb-0 text-nowrap">Total Bookings<br>Todate</p>
											</div>
										</div>
									</div>
								</div>
								...
								<div class="card booking">
									<div class="card-body">
										<div class="booking-status d-flex align-items-center">
											...
											<div class="ms-4">
												<h2 class="mb-0 font-w600">{{ $tt_inquiries }}</h2>
												<p class="mb-0 text-nowrap ">Total Inquiries<br>Todate</p>
											</div>
										</div>
									</div>
								</div>
							...
							<div class="col-xl-3 col-sm-6">
								<div class="card booking">
									<div class="card-body">
										<div class="booking-status d-flex align-items-center">
											<span>
												<svg xmlns="http://www.w3.org/2000/svg" style="color:##ff5200;" width="28" height="28" viewBox="0 0 28 28">
											...
											<div class="ms-4">
												<h2 class="mb-0 font-w600">{{ $checkin }}</h2>
												<p class="mb-0">Current<br>Check In</p>
											</div>
										</div>
									</div>
								</div>
							...
							<div class="col-xl-3 col-sm-6">
								<div class="card booking">
									<div class="card-body">
										<div class="booking-status d-flex align-items-center">
											<span>
												<svg id="_009-log-out" style="color:##ff5200;" data-name="009-log-out" xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 28 28">
											...
											<div class="ms-4">
												<h2 class="mb-0 font-w600">{{ $checkout }}</h2>
												<p class="mb-0">Current<br>Check Out</p>
											</div>
										</div>
									</div>
								</div>
								...
								<div class="card booking">
									<div class="card-body">
										<div class="booking-status d-flex align-items-center">
											...
											<div class="ms-4">
												<h2 class="mb-0 font-w600">{{ $tt_rooms_available }}</h2>
												<p class="mb-0">Total Rooms Available</p>
											</div>
										</div>
									</div>
								</div>
								...
								<div class="card booking">
									<div class="card-body">
										<div class="booking-status d-flex align-items-center">
											...
											<div class="ms-4">
												<h2 class="mb-0 font-w600">{{ $tt_rooms_booked }}</h2>
												<p class="mb-0">Total Rooms Booked</p>
											</div>
										</div>
									</div>
								</div>
							...
							<div class="col-xl-12">
								<div class="card">
										...
										<div class="rooms mt-3 d-flex align-items-center justify-content-between flex-wrap">
											<div class="d-flex align-items-center mb-3">
												@if($booking->room != null)
													<img src="{{ 'public/'.Storage::url($booking->room->image_path) }}" alt="">
												@else
												...
												<div class="ms-4 bed-text">
													<h4>
														@if($booking->room != null)
															{{ $booking->room->room_types->name }} {{ $booking->room->room_number }}
														@endif
													</h4>
													<div class="users d-flex align-items-center">
														...
														<div>
															...
															<span class="fs-16 font-w500 me-3">{{ $booking->guests->users->fname.' '.$booking->guests->users->fname }}</span>
															@endif
											...
											<span class="d-flex align-items-center">
												...
												<span class="badge bg-warning mb-3">Checked In</span>
												@else
												<span class="badge bg-dark mb-3">Checked Out</span>
												@endif
												&nbsp;
												&nbsp;
												&nbsp;
												<span class="date bg-secondary mb-3">
									...
									<div class="card-footer border-0 m-auto pt-0">
										<a href="{{ route('bookings') }}" class="btn  btn-link m-auto dlab-load-more fs-16 font-w500 text-secondary" id="Booking" rel="ajax/booking.html">View more</a>
									</div>
								</div>
							</div>
							{{-- <div class="col-xl-6">
										...
										<div class="card">
											...
											<div class="card-body pb-0">
												<div class="d-flex flex-wrap">
													...
													<span class="fs-16 font-w600 me-4">0 <small class="text-success fs-12 font-w400">+0.4%</small></span>
													...
													<span class="fs-16 font-w600">0</span>
												</div>	
										...
										<div class="card bg-secondary">
											<div class="card-body">
												<div class="d-flex align-items-end pb-4 justify-content-between">
													...
													<span class="fs-20 font-w600 text-white"><span class="pe-2"></span>0</span>
												</div>
										...
										<div class="card">
											<div class="card-body">
												<div class="row">
													...
													<div class="col-xl-3 col-sm-3 col-6 mb-4 col-xxl-6">
														<div class="text-center">
															<h3 class="fs-28 font-w600">0k</h3>
