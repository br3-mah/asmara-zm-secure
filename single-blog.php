              ...
              <div class="comment-list">
                <div class="single-comment justify-content-between d-flex">
                  <div class="user justify-content-between d-flex">
                    ...
                    <div class="desc">
                      <p class="comment">
                        Multiply Poolnight grass fourth day Poollesser rule open
                        subdue female fill which them Blessed, give fill lesser
                        bearing multiply Poolnight grass fourth day Poollesser
                      </p>
          ...
          <div class="row">
            <div class="col-xl-3 col-md-6 col-lg-3">
              <div class="footer_widget">
                ...
                <p class="footer_text">
                  5494, Lunsenfwa Road, Kalundu, <br />
                  Lusaka, Zambia.
                </p>
            ...
            <div class="col-xl-3 col-md-6 col-lg-3">
              <div class="footer_widget">
                ...
                <p class="footer_text">
                  +0211 355 875<br />
                  reservation@asmarahotelzam.com
                </p>
              </div>
            </div>
          ...
          <div class="row">
            <div class="col-xl-8 col-md-7 col-lg-9">
              <p class="copy_right">
                ...
                All rights reserved | Asamarahotel@2020<i
                  class="fa fa-heart-o"
                  aria-hidden="true"
                ></i>
                by
                <a href="https://greenwebbb.com" target="_blank">greenwebbb</a>
                <!-- Link back to greenwebbb can't be removed. Template is licensed under CC BY 3.0. -->
              </p>
            </div>
